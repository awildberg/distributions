module Crystalstats
  ...
  module SpecialMath
    ...
    setter :log_gamma_cache_res, :log_gamma_cache_x,
    ...
    def incomplete_gamma(a = 0.0, x = 0.0)
    ...
    def gamma_series_expansion(a, x)
      ...
      raise "Maximum iterations exceeded: please file a bug report."
      #return -100.0 #"Maximum iterations exceeded: please file a bug report."
    end

    # Author:: Jaco van Kooten
    def gamma_fraction(a : Float64 = 0.0, x : Float64 = 0.0)
      b : Float64 = x + 1.0 - a
      c : Float64 = 1.0 / XMININ
      d : Float64 = 1.0 / b
      h : Float64 = d
      del : Float64 = 0.0
      an : Float64 = 0.0
    ...
    def error(x)
      ...
      return (if x >= 0.0; retval; else -retval end)
    end
  ...
  # author Jaco van Kooten
   ...
   def complementary_error(x)
    ...
    return ( if x >= 0.0; retval; else 2.0 - retval end )
   end
  end
end
